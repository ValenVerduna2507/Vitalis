...
> La única referencia a Rosario en este proyecto corresponde a la institución educativa a la que pertenece el equipo. La sede documentada del centro es la de Pueblo Esther, según la decisión D2 del registro de [`integrantes.md`](../integrantes.md).
...
> Pilates no figuraba en el listado inicial de disciplinas, pero la modalidad de cobro combinada relevada la contempla de forma explícita. Se incorpora al listado documentado según la decisión D3.
...
> Los módulos M6, M7 y M8 estaban contemplados en el alcance del relevamiento inicial pero no contaban con requisitos funcionales propios. Su incorporación corresponde a la decisión D4. Los requisitos que los cubren se incorporan en este documento como requisitos adicionales (RF22 a RF31) y están identificados como tales.
